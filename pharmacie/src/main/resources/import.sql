...
INSERT INTO public.article(id, description, designation, quantite)VALUES ((select nextval('article_id_seq')), 'Aspirine', 'Antalgique et anti_inflamatoire', 10);
INSERT INTO public.article(id, description, designation, quantite)VALUES ((select nextval('article_id_seq')), 'Paracetamol',' Antalgique anti-douleur', 10);
INSERT INTO public.article(id, description, designation, quantite)VALUES ((select nextval('article_id_seq')),' Ibuprofène', 'Anti-inflamatoire', 10);